...
export const caseStudyPages: CaseStudyPageContent[] = [
  {
    ...
    metrics: [
      ...
      { value: "4.4/5", label: "Store rating" },
  ...
  },
  {
    ...
    heroMedia: {
      ...
      caption: "Owned and paid social creative turned the 'Netflix has a shop?' insight into a BFCM retail hook.",
      width: 1477,
      height: 1222,
    ...
    media: [
      ...
      },
      {
        ...
        caption: "Meme-led social creative in partnership with pages like @girls turned familiar Netflix TV moments into campaign content for the 'Netflix has a shop?' idea.",
        width: 1722,
        height: 1222,
        orientation: "landscape",
      },
      ...
      },
      {
        ...
        caption: "Creator-led content extended the campaign beyond paid and owned channels.",
        width: 1001,
        height: 895,
        orientation: "landscape",
      },
    ...
    relevantLinks: [
      ...
      {
        label: "Netflix Shop tutorial video",
  ...
  },
  {
    ...
    timeframe: "Planning in 2022 & 2023 / Campaign ran Sep–Dec 2023",
    ...
    media: [
      {
        ...
        poster: "/case-studies/scoops-ahoy/scoops-ahoy-pint.jpg",
